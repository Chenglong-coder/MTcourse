...
parser.add_argument('-train','--train_path', default='./data/train.txt')
parser.add_argument('-valid','--valid_path', default='./data/valid.txt')
parser.add_argument('-test','--test_path', default='./data/test.txt')
parser.add_argument('-n_hidden','--hidden', default=5, type=int)
parser.add_argument('-train_batch_size','--train_batch_size', default=512, type=int)
parser.add_argument('-valid_batch_size','--valid_batch_size', default=512, type=int)
parser.add_argument('-num_layers','--num_layers', default=1, type=int)
parser.add_argument('-size_window','--size_window', default=4, type=int)
parser.add_argument('-learn_rate','--learn_rate', default=0.0001, type=int)
...
#parameter
n_hidden = args.hidden  #hidden size
train_batch_size = args.train_batch_size
valid_batch_size = args.valid_batch_size
num_layers = args.num_layers  #hidden layers number
size_window = args.size_window   #the size of window to word
learn_rate = args.learn_rate  #learn rate

dtype = torch.FloatTensor    #number type
train_path = args.train_path   #the path of dataset to train
valid_path = args.valid_path   #the path of dataset to valid
test_path = args.test_path     #the path of dataset to test
